...
public class SearchPageTest2 extends TestBase {
	...
	public void setup() throws InterruptedException {
		...
		Thread.sleep(5000);
		loginpage.emailSignin(prop.getProperty("email2"));
		Thread.sleep(5000);
		loginpage.passwordSignin(prop.getProperty("password2"));
		Thread.sleep(5000);
